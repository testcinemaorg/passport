...
export function createPassportOptionsProvider(options: PassportOptions): Provider {
  return {
...
export function createPassportAsyncOptionsProvider(options: PassportAsyncOptions): Provider {
  return {
    provide: PASSPORT_OPTIONS,
